...
def main():
    num_frames = 80
    vgg_model = 'E:\pythonwork\caffe\models\VGG\VGG_ILSVRC_19_layers.caffemodel'
    vgg_deploy = 'E:\pythonwork\caffe\models\VGG\VGG_ILSVRC_19_layers_deploy.prototxt'
    video_path = 'E:\pythonwork\Video_to_sequence\data'
    video_save_path = "E:\pythonwork\Video_to_sequence\data2\youtube_feats"
