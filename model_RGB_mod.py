...
#        print ("caption_mask : ", caption_mask)
#        print ("probs : ", probs)
...
###    
    print ("getting video train data")
...
###
    print("get video train data %s" % video_data['video_path'])
    return train_data

def get_video_test_data(video_data_path, video_feat_path):
###
    print ("getting video test data")
    video_data = pd.read_csv(video_data_path, sep=',')
    video_data = video_data[video_data['Language'] == 'English']
    video_data['video_path'] = video_data.apply(lambda row: row['VideoID']+'_'+str(int(row['Start']))+'_'+str(int(row['End']))+'.avi.npy', axis=1)
    video_data['video_path'] = video_data['video_path'].map(lambda x: os.path.join(video_feat_path, x))
...
###
    print("get video test data %s" % video_data['video_path'])
    return test_data
...
###
#            print("current_captions : ",current_captions)
            print("\t\tProcessing current_captions 1...")
...
###
            ...
            current_caption_ind = []
###
            print("\t\tProcessing current_captions 2...")
...
#            print("current_feats: ", current_feats)
#            print("current_video_masks: ", current_video_masks)
#            print("current_caption_matrix: ", current_caption_matrix)
#            print("current_caption_masks: ", current_caption_masks)
            print("\t\tsess.run\n")
...
###### trap in this area ####
###
            print("\t\tloss_to_draw_epoch.append\n")
