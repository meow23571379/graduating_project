...
video_train_data_path = 'E:\pythonwork\Video_to_sequence\data\data_set\\train.csv'
video_test_data_path = 'E:\pythonwork\Video_to_sequence\data\data_set\\test.csv'

model_path = 'E:\pythonwork\caffe\models\\test_small'
...
def test(model_path='E:\pythonwork\caffe\models\\test_small\model-90'):
    test_data = get_video_test_data(video_test_data_path, video_test_feat_path)
