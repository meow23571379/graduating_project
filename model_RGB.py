...
#video_train_feat_path = 'E:\pythonwork\Video_to_sequence\data\\train'
#video_test_feat_path = 'E:\pythonwork\Video_to_sequence\data\\test'
...
#5/13 editing from above to below
video_path = 'E:\pythonwork\Video_to_sequence\data'
...
video_train_data_path = 'E:\pythonwork\Video_to_sequence\data\data_set\\MSR_Video_Description_Corpus.csv'
video_test_data_path = 'E:\pythonwork\Video_to_sequence\data\data_set\\MSR_Video_Description_Corpus.csv'
...
###        current_train_data = train_data.groupby('video_path').apply(lambda x: x.irow(np.random.choice(len(x))))
        ...
        for start, end in zip(
            ...
            print("\t\t\tProcessing current_feats_vals...")
...
###
            ...
            print("\t\t\tProcessing current_captions...")
            ...
            print("\t\t\tProcessing current_caption_masks...")
...
def test(model_path='E:\pythonwork\caffe\models\model-10m'):
    test_data = get_video_test_data(video_test_data_path, video_test_feat_path)
